...
def test_model(target):
    ...
    test_cases = [
        {
            "name": "simple_test_check1",
            "input": {"num_words": 20, "embedding_dim": 16},
            "expected": {
    ...
    for test_case in test_cases:
        ...
        #         {
        #             "name": test_case["name"],
        #             "expected": test_case["expected"]["layer_3_output.shape"],
        #             "got": model.layers[2].output.shape,
        #         }
        #     )
        #     print(
